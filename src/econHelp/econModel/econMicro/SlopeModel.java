...
public class SlopeModel {
  ...
  * @param txtFieldXOne TextField for x1
  * @param txtFieldYOne TextField for y1
  * @param txtFieldXTwo TextField for x2
  * @param txtFieldYTwo TextField for y2
  * @param message Text to be added for description of slope.
  * @param xy SlopeGraph to be added to the screen
  * @author EconTeam(UMASS BOSTON)
  * @return void
  */
	 ...
	 * @param TextFiled The TextField input to be checked
