...
public class SlopeGraph {
	 ...
	 */
	 ...
	 /**
	  * This method is return the Graph of the slope to the caller. It is responsible for setting the size of axis needed for
	  * the plot, setting the unit of the plot and making an axes of type Axes b passing these values. It is also responsible for
	  * setting the backbrong color of the slope graph.
	  * @return Stack Pane
	  */
	...
	/**
	 * This class is responsible  for creatung Axes for a graph.
	 */
    class Axes extends Pane {
         ...
         * @param width int Width of the slope pane
         * @param height int height of the slope pane
         * @param xLow int value for lowest x coordinate range
         * @param xHi int value for highet x coordinate range
         * @param xTickUnit unit spacing between points  for x axis
         * @param yLow int value for lowest y coordinate range
         * @param yHi int value for highest y coordinate range
         * @param yTickUnit unit for x axis between points for y-axis
         */
        public Axes(
        ...
        /**
         * This method returns the x axis
         * @return NumberAxis
         */
        ...
        /**
         * This method returns the y axis
         * @return NumberAxis
         */
    ...
    class Plot extends Pane {
         ...
         * @param y1 double value of y1
         * @param y2 double value of y2
         * @param Min double value of Min length of axes
         * @param Max double value of Max length of axes
         * @param Inc double value of unit
         * @param Axes The axis for the specified values
         */
    	public Plot(
    	...
    	/**
    	 * This method maps the actual x coordinate to the coordinate in the X-Axes and returns that value.
    	 * @param x double value of x coordinate
    	 * @param axes Axes where x needs to be ploted
    	 * @return double 
    	 */
        ...
        /**
         * This method maps the actual y coordinate to the coordinate in the Y-Axes
         * @param y double value of y coordinate
         * @param axes Axes where y needs to be ploted
         * @return double
         */
